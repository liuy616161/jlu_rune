...
#define NODE_MAIN_LOGGER_NAME "power_rune_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpower_rune.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<power_rune::PowerRuneNode>";
